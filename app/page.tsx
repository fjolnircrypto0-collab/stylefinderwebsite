    ...
    <div className="bg-[#F7F7F2] text-[#1C1C1E] min-h-screen" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Helvetica Neue", sans-serif' }}>
      ...
      <section className="pt-28 pb-8 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-[2.5rem] md:text-[4.2rem] font-black tracking-tight leading-[1.08] mb-5">
            Meet StyleFinder.<br />
            <span className="text-[#1C1C1E]/25">Find any clothing</span><br />
            <span className="text-[#1C1C1E]/25">with just a photo.</span>
          </h1>
          <p className="text-base md:text-[1.05rem] text-[#1C1C1E]/40 max-w-md leading-relaxed mb-8">
